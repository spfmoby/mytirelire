...
<form action="controller/CompteController.php?action=ajouterTransactionDepot&id=$_GET['id']" method="post">
...
<form action="controller/CompteController.php?action=ajouterTransactionRetrait&id=$_GET['id']" method="post">
  <label for="montant">Montant :</label>
  <input type="number" id="montant" name="montant"><br><br>
  <label for="code_PIN">Code PIN :</label>
  <input type="password" id="code_PIN" name="code_PIN"><br><br>
  <input type="submit" value="Ajouter une transaction de retrait">
</form>